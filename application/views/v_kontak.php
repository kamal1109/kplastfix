				...
				<div class="row">
					<div class="col-md-3">
						...
						<ul class="contact-info">
							<BR><i class="icon-map"></i>198 West 21th Street, Suite 721 New York NY 10016</i></BR>
							<BR><i class="icon-phone"></i>+ 1235 2355 98</i></BR>
							<BR><i class="icon-envelope"></i href="#">info@yoursite.com</i></BR>
							<BR><i class="icon-globe"></i href="#">www.yoursite.com</i></BR>
						</ul>
					</div>
					...
					<div class="col-md-8 col-md-push-1 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
						...
						<div class="row">
							<form method="post" action="<?php echo base_url() . 'kontak/kirim_pesan' ?>">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input value="Kirim Pesan" class="btn" type="submit">
									</div>
								</div>
							</form>
						</div>
